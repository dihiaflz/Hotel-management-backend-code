...
dashboardRouter.post("/guests", authMiddleware, async(req, res) => {
    try{
...
dashboardRouter.post("/nbrBookings", authMiddleware, async(req, res) => {
    try {
...
dashboardRouter.post("/nbrDone", authMiddleware, async(req, res) => {
    try {
